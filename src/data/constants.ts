...
using use = useUsing("use")`,
  ...
  [SkillNames.PHP]: {
    ...
    name: "php",
    label: "PHP",
    shortDescription: "The OG of the web, still powering half the internet! 🐘⚡",
    color: "#777bb4",
  ...
  [SkillNames.PYTHON]: {
    ...
    name: "python",
    label: "Python",
    shortDescription: "Simple, powerful, and everyone's favorite snek! 🐍🔥",
    color: "#3776ab",
...
export const EXPERIENCE: Experience[] = [
  {
    ...
    description: [
      "Developed and deployed an electronic voting platform used by municipal councils.",
      "Modernized internal procedures, significantly reducing processing times in municipal bodies.",
      "Built real-time BI dashboards in Looker Studio for provincial metrics.",
    ],
    skills: [
      SkillNames.PHP,
      SkillNames.JS,
  ...
  },
  {
    ...
    description: [
      "Led the complete refactoring of the APB management system (credentials, payments, notifications).",
      "Implemented a real-time QR-based access control system, reducing entry errors to zero.",
    ],
    skills: [
      SkillNames.PHP,
      SkillNames.JS,
  ...
  },
  {
    ...
    company: "Club Atlético Talleres",
    description: [
      "Designed and implemented from scratch a QR-based access control system for instant member validation.",
    ],
    skills: [
      SkillNames.PYTHON,
      SkillNames.FLASK,
