...
using use = useUsing("use")`,
  ...
  [SkillNames.VUE]: {
    ...
    label: "Vue",
    shortDescription:
      "la pastilla relajante para tu frontend, ¡pega diferente! 🟢😌",
    color: "#41b883",
  ...
  [SkillNames.NEXTJS]: {
    ...
    label: "Next.js",
    shortDescription:
      "la reina del drama de los frameworks, ¡y somos fans! 👑📜",
    color: "#fff",
  ...
  [SkillNames.EXPRESS]: {
    ...
    name: "express",
    label: "Express",
    shortDescription: "los middlewares pegan fuerte, ¡sin duda! 🚂💨",
    color: "#fff",
  ...
  [SkillNames.POSTGRES]: {
    ...
    name: "postgres",
    label: "PostgreSQL",
    shortDescription: "SQL pero con estilo, ¡purrr! 💅🐘",
    color: "#336791",
  ...
  [SkillNames.MONGODB]: {
    ...
    name: "mongodb",
    label: "MongoDB",
    shortDescription: "presumiendo con ese flow de NoSQL, ¡con respeto! 💪🍃",
    color: "#336791",
  ...
  [SkillNames.GIT]: {
    ...
    name: "git",
    label: "Git",
    shortDescription: "el guardaespaldas personal del código, ¡sin duda! 🕵️‍♂️🔄",
    color: "#f1502f",
  ...
  [SkillNames.GITHUB]: {
    ...
    name: "github",
    label: "GitHub",
    shortDescription: "deslizándose en esos pull requests, ¡los que saben, saben! 🐙",
    color: "#000000",
  ...
  [SkillNames.NPM]: {
    ...
    name: "npm",
    label: "NPM",
    shortDescription: "el gestor de paquetes dijo 'te banco, bro', ¡y listo! 📦💯",
    color: "#fff",
  ...
  [SkillNames.FIREBASE]: {
    ...
    label: "Firebase",
    shortDescription:
      "el mejor compañero para tu app, ¡pero ojo con la dependencia! 🔥👌",
    color: "#ffca28",
  ...
  [SkillNames.WORDPRESS]: {
    ...
    name: "wordpress",
    label: "WordPress",
    shortDescription: "el abuelo de los CMS, todavía rockeando con bastón 🧓👴",
    color: "#007acc",
  ...
  [SkillNames.LINUX]: {
    ...
    name: "linux",
    label: "Linux",
    shortDescription: "donde 'chmod 777' es el poder absoluto 🔓🙌",
    color: "#fff",
  ...
  [SkillNames.NGINX]: {
    ...
    name: "nginx",
    label: "NginX",
    shortDescription: "el proxy inverso va a toda velocidad, ¡epa! 🚗💨",
    color: "#008000",
  ...
  [SkillNames.AWS]: {
    ...
    label: "AWS",
    shortDescription:
      "siempre extra, complicando todo lo que puede, ¡y listo! 🌐👨‍💻",
    color: "#ff9900",
  ...
  [SkillNames.GCP]: {
    ...
    label: "Google Cloud",
    shortDescription:
      "computación en la nube pero con vibras de Google, ¡viviendo gratis! ☁️🔥",
    color: "#4285f4",
  ...
  [SkillNames.VIM]: {
    ...
    name: "vim",
    label: "Vim",
    shortDescription: "¿salir? ¿en esta economía? ¡Bueno, me retiro! 🚪🏃",
    color: "#e34c26",
  ...
  [SkillNames.CPP]: {
    ...
    name: "cpp",
    label: "C++",
    shortDescription: "el rendimiento es el rey, ¡pero la sintaxis es una batalla! ⚔️🚀",
    color: "#00599c",
  ...
  [SkillNames.ELIXIR]: {
    ...
    name: "elixir",
    label: "Elixir",
    shortDescription: "escalabilidad y tolerancia a fallos con vibras funcionales! 💧✨",
    color: "#4e2a8e",
  ...
  [SkillNames.R]: {
    ...
    name: "r",
    label: "R",
    shortDescription: "estadísticas, datos y gráficos que pegan diferente! 📊📉",
    color: "#276dc3",
  ...
  [SkillNames.ORACLE]: {
    ...
    name: "oracle",
    label: "Oracle DB",
    shortDescription: "datos de nivel empresarial, ¡confiables y robustos! 🏛️💾",
    color: "#f80000",
  ...
  [SkillNames.MYSQL]: {
    ...
    name: "mysql",
    label: "MySQL",
    shortDescription: "¡la base de datos de código abierto más popular del mundo! 🐬💾",
    color: "#4479a1",
  ...
  [SkillNames.SQLSERVER]: {
    ...
    name: "sqlserver",
    label: "SQL Server",
    shortDescription: "el peso pesado de Microsoft para los datos! 🏗️💾",
    color: "#a91d22",
  ...
  [SkillNames.LOOKER]: {
    ...
    name: "looker",
    label: "Looker Studio",
    shortDescription: "¡visualizando datos como un profesional! 📊✨",
    color: "#4285f4",
  ...
  [SkillNames.FLASK]: {
    ...
    name: "flask",
    label: "Flask",
    shortDescription: "¡framework web de Python ligero y potente! 🧪🔥",
    color: "#fff",
...
export const EXPERIENCE: Experience[] = [
  ...
  },
  {
    ...
    company: "Centro Atlético Paracao",
    description: [
